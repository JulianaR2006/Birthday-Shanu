const crosswordConfig = {
  ...
  cols: 18,
  words: [
    { key: 'HAPPY', answer: 'HAPPY', row: 2, col: 5, direction: 'across', hidden: true, prefill: [0, 1, 2, 3, 4] },
    { key: 'BIRTHDAY', answer: 'BIRTHDAY', row: 6, col: 2, direction: 'across', hidden: true, prefill: [0, 1, 2, 3, 4, 5, 6, 7] },
    { key: 'SHANU', answer: 'SHANU', row: 6, col: 12, direction: 'across', hidden: true, prefill: [0, 1, 2, 3, 4] },
    { key: 'LIME', answer: 'LIME', row: 0, col: 1, direction: 'down', clue: 'Zesty green fruit' },
    { key: 'PONY', answer: 'PONY', row: 0, col: 10, direction: 'down', clue: 'Small horse' },
    { key: 'HUG', answer: 'HUG', row: 2, col: 5, direction: 'down', clue: 'Squeeze with affection' },
    { key: 'GIG', answer: 'GIG', row: 0, col: 12, direction: 'down', clue: 'One-night performance' },
    { key: 'NEST', answer: 'NEST', row: 4, col: 2, direction: 'across', clue: 'Snug bird home' },
    { key: 'IMAGE', answer: 'IMAGE', row: 9, col: 0, direction: 'across', clue: 'Picture or likeness' },
    { key: 'MAGIC', answer: 'MAGIC', row: 1, col: 6, direction: 'down', clue: 'A kind of sparkle' },
